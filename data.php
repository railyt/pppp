...
<form method="POST" >
	<label>Linn</label><br>
	<input name="City" type="text"><?php echo $CityError;?>
	<br><br>
	<label>Kino</label><br>
	<input name="Cinema" type="text"><?php echo $CinemaError;?>
	<br><br>
	<label>Film</label><br>
	<input name="Movie" type="text"><?php echo $MovieError;?>
	<br><br>
	<label>Žanr</label><br>
	<input name="Genre" type="text"><?php echo $GenreError;?>
	<br><br>
